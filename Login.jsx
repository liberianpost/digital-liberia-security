...
function Login({ onLoginSuccess, onBack }) {
  ...
  const requestDSSNChallenge = async (dssn) => {
    try {
      ...
      const response = await api.post('/gov-services/request', { 
        dssn, 
        service: "Digital Liberia Security System", // Changed to Security System
        fcmToken,
        requestData: {
          timestamp: new Date().toISOString(),
          service: "Digital Liberia Security System - National Access", // Updated service name
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log('Initiating security DSSN challenge for:', dssn);
      ...
      const interval = setInterval(async () => {
        try {
          ...
          if (statusResponse.status === 'approved') {
            ...
            setPolling(false);
            console.log('Security system login approved with token:', statusResponse.govToken);
            ...
            clearInterval(interval);
            setPolling(false);
            setError("Security access was denied on your mobile device");
          }
        } catch (error) {
          console.error('Error polling challenge status:', error);
          clearInterval(interval);
    ...
    <div className="login-container">
      <div className="login-content">
        ...
        <div className="login-header">
          ...
          <h2>Security Personnel Verification</h2>
          <p>
            Enter your DSSN to access Digital Liberia Security System
          </p>
          <div style={{
            ...
            🔐 Secure security access for authorized personnel only
          </div>
        </div>
        ...
        <div className="login-form">
          ...
          {polling ? (
            <div className="verification-pending">
              ...
              <p style={{ color: 'var(--text-light)', marginBottom: '1.5rem', fontSize: '1.1rem' }}>
                Please check your mobile app to approve this security access request.
              </p>
              ...
              <p className="challenge-id">
                Security Verification ID: {challengeId}
              </p>
              <p className="timeout-notice">
                This security access request will timeout in 5 minutes
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit}>
              <div className="form-group">
                ...
                <p className="input-help">
                  Enter your DSSN and approve the security access request on your mobile app
                </p>
              </div>
          ...
          <div className="login-footer">
            <p className="access-info" style={{ 
              ...
              🛡️ Secure security system for authorized personnel
            </p>
          </div>
        </div>
      </div>
